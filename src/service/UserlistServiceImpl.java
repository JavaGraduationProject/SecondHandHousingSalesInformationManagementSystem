...
public class UserlistServiceImpl implements UserlistService {
	...
	public User finduserbyid(Integer id) {
		User user = userlistMapper.finduserbyid(id);
		return user;
	}
	@Override
	public void modifypassword(User user) {
		userlistMapper.modifypassword(user);
		
	}
	@Override
	public List<User> findalluser() {
		List<User> userlist = userlistMapper.findalluser();
		return userlist;
	}
	@Override
	public List<User> findalluserbyid(Integer id) {
		List<User> userlist = userlistMapper.findalluserbyid(id);
		return userlist;
	}
